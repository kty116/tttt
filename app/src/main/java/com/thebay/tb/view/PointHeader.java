...
public class PointHeader extends RelativeLayout implements View.OnClickListener {
    ...
    public PointHeader(Context context) {
        super(context);
        init(context);
    }

    public PointHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PointHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context) {
        ...
        inflate(context, R.layout.list_header_point, this);
