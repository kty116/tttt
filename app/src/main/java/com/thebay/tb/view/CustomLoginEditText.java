...
public class CustomLoginEditText extends LinearLayout implements View.OnFocusChangeListener {
...
//        initView();
    ...
    public CustomLoginEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public CustomLoginEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initView(context, attrs);
    }
