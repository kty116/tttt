...
public class DepositRefundHeader extends RelativeLayout implements View.OnClickListener {

    public DepositRefundHeader(Context context) {
        super(context);
        init(context);
    }

    public DepositRefundHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DepositRefundHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context) {
        ...
        inflate(context, R.layout.list_header_deposit_refund, this);
