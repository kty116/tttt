...
import com.thebay.tb.model.CouponTransferListModel;
...
public class CouponTransferListTabFragment extends Fragment implements Serializable {
...
//    }
    ...
    public static CouponTransferListTabFragment newInstance() {
        CouponTransferListTabFragment fragment = new CouponTransferListTabFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.tab_coupon_transfer, container, false);
...
//        fab.setVisibility(View.GONE);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //init data
        ArrayList<CouponTransferListModel> dataList = new ArrayList<>();
        for (int i = 0; i < 100; i++) {
            dataList.add(new CouponTransferListModel("No", "할인쿠폰", "할인", "유효기간", "발급일/양도일", "사용일", "상태"));
        }
...
//        params.put("key","value");
    ...
    public class ListAdapter extends RecyclerView.Adapter {
        ...
        private ArrayList<CouponTransferListModel> mDataList = new ArrayList<>();

        public ListAdapter(Context context) {
            mLayoutInflater = LayoutInflater.from(context);
        }

        public void setData(ArrayList<CouponTransferListModel> list) {
            this.mDataList = list;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(mLayoutInflater.inflate(R.layout.list_item_coupon_transfer, parent, false));
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            viewHolder.dateTransferText.setText(mDataList.get(position).getDateTransfer());
        ...
        private class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private TextView dateTransferText;
            ...
            public ViewHolder(View itemView) {
                ...
                dateTransferText = (TextView) itemView.findViewById(R.id.transfer_date_text);
