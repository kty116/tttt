...
import com.thebay.tb.adapter.MessageListAdapter;
...
//    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 100; i++) {
            int num = i + 1;
            list.add(new MessageListModel("No." + num, new Date(System.currentTimeMillis()).toString(), "DASFWEFQWEFHEWUHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHWEEEEEEEEEEEEEE"));
        }
...
//                EventBus.getDefault().post(new FragmentReplaceEvent(MessageDetailsFragment.newInstance(),"상세보기"));
                CommonLib.subActivityIntent(getActivity(),MessageDetailsFragment.newInstance());
